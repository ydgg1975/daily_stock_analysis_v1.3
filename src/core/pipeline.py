    ...
    def __init__(
        ...
        try:
            self.search_service = SearchService(
                ...
                openai_web_search_keys=self.config.openai_web_search_api_keys,
                openai_web_search_model=self.config.openai_web_search_model,
                openai_web_search_base_url=self.config.openai_web_search_base_url,
