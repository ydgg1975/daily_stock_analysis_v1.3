...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "OPENAI_WEB_SEARCH_API_KEYS": {
        "title": "OpenAI Web Search API Keys",
        "description": "Comma-separated OpenAI API keys for model-backed web search. Use a dedicated key separate from the analysis LLM provider.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "OPENAI_WEB_SEARCH_MODEL": {
        "title": "OpenAI Web Search Model",
        "description": "OpenAI model used for web search.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "OPENAI_WEB_SEARCH_BASE_URL": {
        "title": "OpenAI Web Search Base URL",
        "description": "OpenAI API base URL for Web Search. Default: https://api.openai.com/v1.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
