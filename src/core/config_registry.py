...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "EXTENSIONS_ENABLED": {
        ...
        "description": "Enable the Extension Runtime framework. Individual plugins can still remain disabled.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "EXTENSIONS_AUTOLOAD_BUILTIN": {
        "title": "Autoload Built-in Extensions",
        "description": "Automatically load built-in extension manifests when the Extension Runtime is enabled.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "EXTENSIONS_ALPHASIFT_ENABLED": {
        "title": "AlphaSift Extension Enabled",
        "description": "Enable the built-in AlphaSift manifest. Candidate discovery actions are wired in later phases.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "MAX_ACTION_CALL_DEPTH": {
        "title": "Max Action Call Depth",
        "description": "Maximum nested action call depth used to prevent recursive extension loops.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
