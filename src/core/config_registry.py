...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "GENERATION_BACKEND": {
        ...
        "description": "Model-call channel used by stock analysis, market reviews, and regular text generation.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "GENERATION_FALLBACK_BACKEND": {
        ...
        "description": "Reserved fallback channel for future multi-channel generation; keep LiteLLM for the current default behavior.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "AGENT_GENERATION_BACKEND": {
        ...
        "description": "Model-call channel used by the ask-stock assistant to generate replies and use tools.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
