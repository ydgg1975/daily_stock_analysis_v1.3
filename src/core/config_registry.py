...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "PRE_TRADE_REVIEW_ENABLED": {
        ...
        "description": "Append an optional capital-aware advisory verdict (approve/approve_with_concerns/reject) to each recommendation. Advisory-only: never overrides the BUY/SELL conclusion and never blocks the pipeline. Default off.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 70,
        "help_key": "settings.system.PRE_TRADE_REVIEW_ENABLED",
        "examples": [
            "PRE_TRADE_REVIEW_ENABLED=false",
            "PRE_TRADE_REVIEW_ENABLED=true",
        ],
        "docs": [
            {
                "label": "集成讨论：Issue #1659",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/issues/1659",
            },
        ],
        "warning_codes": [],
    },
    "PRE_TRADE_REVIEW_ENDPOINT": {
        ...
        "description": "HTTP endpoint of the pre-trade review service. Default: the invinoveritas public API at https://api.babyblueviper.com/review. Any endpoint that accepts the same POST {artifact, artifact_type, context?, sign?} contract and returns {verdict, confidence?, issues?, proof?} can be substituted (self-hosted or proxied).",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "https://api.babyblueviper.com/review",
        "options": [],
        "validation": {},
        "display_order": 71,
        "help_key": "settings.system.PRE_TRADE_REVIEW_ENDPOINT",
        "examples": [
            "PRE_TRADE_REVIEW_ENDPOINT=https://api.babyblueviper.com/review",
        ],
        "docs": [
            {
                "label": "集成讨论：Issue #1659",
    ...
    "PRE_TRADE_REVIEW_API_KEY": {
        ...
        "description": "Bearer API key for the pre-trade review service. Required only when PRE_TRADE_REVIEW_ENABLED=true.",
        "category": "system",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 72,
        "help_key": "settings.system.PRE_TRADE_REVIEW_API_KEY",
        "examples": [
            "PRE_TRADE_REVIEW_API_KEY=your_key_here",
        ],
        "docs": [
            {
                "label": "集成讨论：Issue #1659",
    ...
    "PRE_TRADE_REVIEW_TIMEOUT": {
        ...
        "description": "Short request timeout for the advisory call. Kept small on purpose so the advisory never stalls the analysis pipeline.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 73,
        "help_key": "settings.system.PRE_TRADE_REVIEW_TIMEOUT",
        "examples": [
            "PRE_TRADE_REVIEW_TIMEOUT=8",
        ],
        "docs": [
            {
                "label": "集成讨论：Issue #1659",
