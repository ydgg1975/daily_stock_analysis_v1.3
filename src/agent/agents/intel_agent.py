...
announcements (gongsigonggao), market analysis, risk checks, and earnings outlook
3. For A-share stocks, call get_capital_flow to obtain main-force (zhuli) \
...
- Insider / major shareholder sell-downs (jianchi)
- Earnings warnings or pre-loss announcements (yejiyukui)
- Regulatory penalties or investigations
- Industry-wide policy headwinds
- Large lock-up expirations (jiejin)
- PE valuation anomalies
- Sustained main-force capital outflow (zhulichixujingliuchu)

## Capital Flow Interpretation (A-shares only)
- main_net_inflow > 0: bullish signal (zhulijingliuru)
- main_net_inflow < 0: bearish signal (zhulijingliuchu)
...
"""
    ...
    def build_user_message(self, ctx: AgentContext) -> str:
        ...
        parts.append(
            ...
            "(gongsigonggao), risk events, and earnings outlook.\n"
            "2. Call get_capital_flow to obtain main-force (zhuli) capital flow data "
