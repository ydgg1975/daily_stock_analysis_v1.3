...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "thesis_status_label": "假设状态",
        "current_thesis_label": "当前假设",
        "previous_thesis_label": "上次假设",
        "key_changes_label": "关键变化",
        "evidence_graph_heading": "依据关系图",
        "evidence_graph_summary_label": "关系摘要",
        "stale_evidence_label": "过期/受限节点",
        "risk_engine_heading": "风险引擎",
        "risk_level_label": "风险等级",
        "risk_score_label": "风险分",
        "volatility_label": "年化波动率",
        "max_drawdown_label": "最大回撤",
        "position_caution_label": "仓位注意事项",
