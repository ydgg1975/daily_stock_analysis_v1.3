    ...
    if left and not right:
        ...
        target.append(
            ...
            _issue(
                ...
                f"{channel_name} has {left_key} configured, but {right_key} is missing. This channel will not be enabled.",
    ...
    if right and not left:
        ...
        target.append(
            ...
            _issue(
                ...
                f"{channel_name} has {right_key} configured, but {left_key} is missing. This channel will not be enabled.",
...
def run_notification_diagnostics(config: Config) -> NotificationDiagnosticResult:
    ...
    info: List[NotificationDiagnosticIssue] = [
        ...
        _issue(
            ...
            "notificationzhenduanhuijianchaqudaojixian?걕hiduzhenduan?갮eb test?갥3 luyouconfig?갥4 jiangzaoconfighe P6 ntfy/Gotify qudao??",
        ...
        try:
            ...
            errors.append(
                ...
                _issue(
                    ...
                    f"NOTIFICATION_QUIET_HOURS configwuxiao: {exc}",
        ...
        try:
            ...
            errors.append(
                ...
                _issue(
                    ...
                    f"NOTIFICATION_TIMEZONE configwuxiao: {exc}",
...
def format_notification_diagnostics(result: NotificationDiagnosticResult) -> str:
    ...
    lines = [
        ...
        "notificationconfigzhenduan",

        f"yiconfigqudao: {len(result.configured_channels)} ge",
    ...
    if result.configured_channels:
        ...
        lines.append("qudaoliebiao: " + ", ".join(channel_names))

    else:

        lines.append("qudaoliebiao: (wu)")
