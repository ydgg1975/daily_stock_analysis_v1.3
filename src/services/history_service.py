...
class HistoryService:
        ...
        try:
            ...
            if start_date:
                ...
                try:
                    ...
                    logger.warning(f"wuxiaode start_date geshi: {start_date}")
            ...
            if end_date:
                ...
                try:
                    ...
                    logger.warning(f"wuxiaode end_date geshi: {end_date}")
    ...
    def get_history_detail_by_id(self, record_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"genju ID chaxunlishixiangqingshibai: {e}", exc_info=True)
    ...
    def get_news_intel_by_record_id(self, record_id: int, limit: int = 20) -> List[Dict[str, str]]:
        ...
        try:
            ...
            logger.error(f"genju record_id chaxunxinwenqingbaoshibai: {e}", exc_info=True)
    ...
    def _rebuild_analysis_result(
        ...
        try:
            ...
            return AnalysisResult(
                ...
                confidence_level=raw_result.get("confidence_level", "zhong"),
    ...
    def _generate_single_stock_markdown(
        ...
        analysis_date_label = "Analysis Date" if report_language == "en" else "analysisriqi"

        report_time_label = "Report Time" if report_language == "en" else "baogaoshengchengshijian"
        ...
        report_lines = [
            ...
            f"# ?뱤 {name_escaped} ({result.code}) {labels['report_title']}",
        ...
        if data_persp:
            ...
            if chip_data:
                ...
                if normalized_chip_health in {"jiankang", "healthy"}:

                    chip_emoji = "??"

                elif normalized_chip_health in {"yiban", "average"}:
