...
COMMENT_MAP = [
    # 종료 배의적 매핑 (기술박)
    ("zhize\u7aca?", "\u804c\u8d23\uff1a"),
    ("(chinese removed)", "\u7ba1\u7406\u6574\u4e2a\u5206\u6790\u6d41\u7a0b"),
    ("xietiaoshujuhuoqu?\uac37unchu?\uac4cousuo?\uac4eenxi?\uac3dongzhidengmokuai",
     "\u534f\u8c03\u6570\u636e\u83b7\u53d6\u3001\u7f13\u5b58\u3001\u641c\u7d22\u3001\u5206\u6790\u3001\u901a\u77e5\u7b49\u6a21\u5757"),
    ("(chinese removed)", "\u5b9e\u73b0\u5e76\u53d1\u63a7\u5236\u548c\u5f02\u5e38\u5904\u7406"),
    ("(chinese removed)", "\u63d0\u4f9b\u80a1\u7968\u5206\u6790\u7684\u6838\u5fc3\u529f\u80fd"),
    ("(chinese removed)", "\u521d\u59cb\u5316\u8c03\u5ea6\u5668"),
    ("(chinese removed)", "\u6570\u636e\u6e90\u57fa\u7c7b\u4e0e\u7ba1\u7406\u5668"),
    ("shejimoshi\uff1acelvemoshi (Strategy Pattern)", "\u8bbe\u8ba1\u6a21\u5f0f\uff1a\u7b56\u7565\u6a21\u5f0f (Strategy Pattern)"),
    ("BaseFetcher: chouxiangjilei\uff0cdingyitongyi(chinese removed)", "BaseFetcher: \u62bd\u8c61\u57fa\u7c7b\uff0c\u5b9a\u4e49\u7edf\u4e00\u63a5\u53e3"),
    ("DataFetcherManager: celveguanliqi\uff0cshixianzidongqiehuan", "DataFetcherManager: \u7b56\u7565\u7ba1\u7406\u5668\uff0c\u5b9e\u73b0\u81ea\u52a8\u5207\u6362"),
    ("fangfengjincelve\uff1a", "\u9632\u5c01\u7981\u7b56\u7565\uff1a"),
    ("(chinese removed) Fetcher (chinese removed)", "\u6bcf\u4e2a Fetcher \u5185\u7f6e\u6d41\u63a7\u903b\u8f91"),
    ("(chinese removed)", "\u5931\u8d25\u81ea\u52a8\u5207\u6362\u5230\u4e0b\u4e00\u4e2a\u6570\u636e\u6e90"),
    ("(chinese removed)", "\u6307\u6570\u9000\u907f\u91cd\u8bd5\u673a\u5236"),
    ("(chinese removed)", "\u914d\u7f6e\u65e5\u5fd7"),
    ("(chinese removed)", "\u6807\u51c6\u5316\u5217\u540d\u5b9a\u4e49"),
    ("(chinese removed)", "\u6570\u636e\u5904\u7406"),
    ("AI (chinese removed)", "AI \u5206\u6790"),
    ("sousuoyinqing\uff08yongyuhuoqugupiaoxinwen\uff09", "\u641c\u7d22\u5f15\u64ce\uff08\u7528\u4e8e\u83b7\u53d6\u80a1\u7968\u65b0\u95fb\uff09"),
    ("(chinese removed)", "\u7f51\u7edc\u8bf7\u6c42"),
    ("(chinese removed)", "\u6570\u636e\u5e93"),
    ("baogaomubanyinqing\uff08Report Engine P0\uff09", "\u62a5\u544a\u6a21\u677f\u5f15\u64ce\uff08Report Engine P0\uff09"),
    ("Web (chinese removed)", "Web \u6846\u67b6"),
    ("(chinese removed)", "\u6838\u5fc3\u4f9d\u8d56"),
    ("shujuyuanyilai\uff08duoyuancelve\uff0canyouxianjipaixu\uff09", "\u6570\u636e\u6e90\u4f9d\u8d56\uff08\u591a\u6e90\u7b56\u7565\uff0c\u6309\u4f18\u5148\u7ea7\u6392\u5e8f\uff09"),
    ("Discord (chinese removed)", "Discord \u673a\u5668\u4eba"),
    ("(chinese removed)", "\u63a5\u53e3"),
    ("texing\uff1a", "\u7279\u6027\uff1a"),
    ("(chinese removed)", "\u5f02\u6b65\u4efb\u52a1\u961f\u5217"),
    ("(chinese removed)", "\u9632\u91cd\u590d\u63d0\u4ea4"),
    ("(chinese removed)", "\u5b9e\u65f6\u63a8\u9001"),
    ("jilu\u7aca?", "\u8bb0\u5f55\uff1a"),
    ("ceshi\u7aca?", "\u6d4b\u8bd5\uff1a"),
    ("shili\u7aca?", "\u793a\u4f8b\uff1a"),
    ("shuoming\u7aca?", "\u8bf4\u660e\uff1a"),
    ...
    ("tishi\u7aca?", "\u63d0\u793a\uff1a"),
    # 공통 데이터 소스 이름
    ("(chinese removed)", "\u4e1c\u65b9\u8d22\u5bcc\u6570\u636e\u6e90"),
    ("(chinese removed)", "\u4e1c\u65b9\u8d22\u5bcc\u722c\u866b\u6570\u636e\u6e90"),
    ("(chinese removed) Pro API", "\u4e07\u5f97\u56fe Pro API"),
    ("(chinese removed)", "\u901a\u8fbe\u4fe1\u884c\u60c5\u670d\u52a1\u5668"),
    ("(chinese removed)", "\u8bc1\u5238\u5b9d\u6570\u636e"),
    ("(chinese removed) OpenAPI", "\u957f\u6865 OpenAPI"),
