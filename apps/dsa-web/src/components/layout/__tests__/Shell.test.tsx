...
describe('Shell', () => {
  it.skip('renders navigation, theme toggle and completion badge', () => {
    ...
    expect(screen.getAllByRole('button', { name: 'qiehuanzhuti' }).length).toBeGreaterThan(0);
    expect(screen.getByRole('link', { name: 'wengu' })).toBeInTheDocument();
  ...
  it.skip('opens the theme menu from the sidebar toggle', async () => {
    ...
    fireEvent.click(screen.getAllByRole('button', { name: 'qiehuanzhuti' })[0]);
