...
import { BarChart3, Bell, BriefcaseBusiness, Clock, Home, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'history', labelKey: 'layout.nav.history', to: '/history', icon: Clock },
