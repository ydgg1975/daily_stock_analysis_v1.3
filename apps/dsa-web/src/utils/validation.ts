...
const STOCK_CODE_PATTERNS = [
  /^\d{6}$/, // Korean stock candidate, for example 005930
  /^(KR|KS|KQ)\d{6}$/, // Korean stock code, for example KR005930 or KQ091990
...
/**
 * Validate common Korean and US stock code formats.
 */
