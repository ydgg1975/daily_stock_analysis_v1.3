...
Usage:
    ...
    /research 600519 jinqiyejifengxian            -> Focused research with specific question

    /research xinnengyuanbankuaiqianjinganalysis              -> Topic-based research
...
class ResearchCommand(BotCommand):
    ...
    Usage:
        ...
        /research 600519 yejifengxiananalysis        -> Focused question

        /research xinnengyuanbankuai fazhanqianjing         -> Sector research
    ...
    def execute(self, message: BotMessage, args: List[str]) -> BotResponse:
        ...
        if not args:
            ...
            return BotResponse.text_response(
                ...
                "Example: /research 600519 jinqiyounaxiefengxian\n"

                "Example: /research xinnengyuanbankuaiqianjinganalysis"
        ...
        if not config.agent_mode:
            ...
            return BotResponse.text_response(
                ...
                "Agent mode is disabled. Set `AGENT_MODE=true` in config to use research."
        ...
        try:
            ...
            if getattr(result, "timed_out", False):
                ...
                return BotResponse.text_response(
                    ...
                    f"Research timed out ({duration}s / {research_timeout}s). Please retry with a narrower scope."
            ...
            if result.success:
                ...
                header = f"?뵮 **Deep Research Report**\n"
                ...
                return BotResponse.text_response(
                    ...
                    f"?좑툘 Research did not complete successfully.\n"
