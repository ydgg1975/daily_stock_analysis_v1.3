...
class DingtalkPlatform(BotPlatform):
    ...
    zhichi竊?
    - qiyeneibujiqirenhuidiao
    - qunjiqiren Outgoing huidiao
    - xiaoxiqianmingyanzheng
    
    configyaoqiu竊?
    - DINGTALK_APP_KEY: yingyong AppKey
    - DINGTALK_APP_SECRET: yingyong AppSecret竊늶ongyuqianmingyanzheng竊?
    """
    ...
    def verify_request(self, headers: Dict[str, str], body: bytes) -> bool:
        """
        yanzhengdingdingqingqiuqianming
        
        dingdingqianmingsuanfa竊?
        1. huoqu timestamp he sign
        2. jisuan竊쉇ase64(hmac_sha256(timestamp + "\n" + app_secret))
        3. biduiqianming
        """
        ...
        # yanzhengshijianchuo竊?xiaoshineiyouxiao竊?
        try:
    ...
    def parse_message(self, data: Dict[str, Any]) -> Optional[BotMessage]:
        ...
        dingding Outgoing jiqirenxiaoxigeshi竊?
        {
            "msgtype": "text",
            "text": {
    ...
    def _extract_command(self, text: str) -> str:
        ...
        dingdingde @yonghu geshitongchangshi @nicheng hougenkongge
        """
        # jiandanchuli竊쉤ichukaitoude @xxx bufen
        import re
        # pipeikaitoude @xxx竊늷hongyingwendoukeneng竊?
    ...
    def format_response(
        ...
        """
        geshihuadingdingxiangying
        
        dingding Outgoing jiqirenkeyizhijiezaixiangyingzhongfanhuixiaoxi??
        yekeyishiyong sessionWebhook yibusend??
    ...
    def send_by_session_webhook(
        ...
        """
        tongguo sessionWebhook sendxiaoxi
        
        shiyongyuxuyaoyibusendhuoduotiaoxiaoxidechangjing??
        
        Args:
            session_webhook: dingdingtigongdehuihua Webhook URL
