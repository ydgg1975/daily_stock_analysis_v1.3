...
"""
===================================
shujuyuanjileiyuguanliqi
===================================

shejimoshi：celvemoshi (Strategy Pattern)
- BaseFetcher: chouxiangjilei，dingyitongyijiekou
- DataFetcherManager: celveguanliqi，shixianzidongqiehuan

fangfengjincelve：
1. meige Fetcher neizhiliukongluoji
2. shibaizidongqiehuandaoxiayigeshujuyuan
3. zhishutuibizhongshijizhi
"""
...
def _is_us_market(code: str) -> bool:
    """panduanshifouweimeigu/meiguzhishudaima（buhanzhongwenqianhouzhui）。"""
...
def _is_hk_market(code: str) -> bool:
    """
    pandingshifouweiganggudaima。

    zhichi `HK00700` jichun 5 weishuzixingshi（A gu ETF/gupiaochangjianwei 6 wei）。
    """
    normalized = (code or "").strip().upper()
...
def _is_etf_code(code: str) -> bool:
    """panding A gu ETF jijindaima（baoshouguize）。"""
...
def _market_tag(code: str) -> str:
    """fanhuishichangbiaoqian: cn/us/hk."""
...
class DataFetchError(Exception):
    """shujuhuoquyichangjilei"""
    pass


class RateLimitError(DataFetchError):
    """API sulvxianzhiyichang"""
    pass


class DataSourceUnavailableError(DataFetchError):
    """shujuyuanbukeyongyichang"""
    pass


class BaseFetcher(ABC):
    """
    shujuyuanchouxiangjilei
    
    zhize：
    1. dingyitongyideshujuhuoqujiekou
    2. tigongshujubiaozhunhuafangfa
    3. shixiantongyongdejishuzhibiaojisuan
    
    zileishixian：
    - _fetch_raw_data(): congjutishujuyuanhuoquyuanshishuju
    - _normalize_data(): jiangyuanshishujuzhuanhuanweibiaozhungeshi
    """
    ...
    def _fetch_raw_data(self, stock_code: str, start_date: str, end_date: str) -> pd.DataFrame:
        """
        congshujuyuanhuoquyuanshishuju（zileibixushixian）
        
        Args:
            stock_code: gupiaodaima，ru '600519', '000001'
            start_date: kaishiriqi，geshi 'YYYY-MM-DD'
            end_date: jieshuriqi，geshi 'YYYY-MM-DD'
            
        Returns:
            yuanshishuju DataFrame（liemingyinshujuyuaneryi）
        """
        pass
    ...
    def _normalize_data(self, df: pd.DataFrame, stock_code: str) -> pd.DataFrame:
        """
        biaozhunhuashujulieming（zileibixushixian）

        jiangbutongshujuyuandeliemingtongyiwei：
    ...
    def get_main_indices(self, region: str = "cn") -> Optional[List[Dict[str, Any]]]:
        ...
        Args:
            region: shichangquyu，cn=Agu us=meigu

        Returns:
            List[Dict]: zhishuliebiao，meigeyuansuweizidian，baohan:
                - code: zhishudaima
                - name: zhishumingcheng
                - current: dangqiandianwei
                - change: zhangdiedianshu
                - change_pct: zhangdiefu(%)
    ...
    def get_market_stats(self) -> Optional[Dict[str, Any]]:
        ...
        Returns:
            Dict: baohan:
                - up_count: shangzhangjiashu
                - down_count: xiadiejiashu
                - flat_count: pingpanjiashu
                - limit_up_count: zhangtingjiashu
                - limit_down_count: dietingjiashu
                - total_amount: liangshichengjiaoe
        """
        return None
    ...
    def get_sector_rankings(self, n: int = 5) -> Optional[Tuple[List[Dict], List[Dict]]]:
        ...
        Returns:
            Tuple: (lingzhangbankuailiebiao, lingdiebankuailiebiao)
        """
        return None
    ...
    def get_concept_rankings(self, n: int = 5) -> Optional[Tuple[List[Dict], List[Dict]]]:
        ...
        Returns:
            Tuple: (lingzhanggainianliebiao, lingdiegainianliebiao)
        """
        return None

    def get_hot_stocks(self, n: int = 10) -> Optional[List[Dict[str, Any]]]:
        """
        huoqushichangrenqigubang。

        Returns:
            List[Dict]: renqiguliebiao
        """
        return None
    ...
    def get_limit_up_pool(
        ...
        """
        huoquzhangtingchi/lianbantidui。

        Args:
            date: YYYYMMDD，morenyoujutishujuyuanjueding
            n: fanhuitiaoshu
        """
        return None
    ...
    def get_daily_data(
        ...
        """
        huoqurixianshuju（tongyirukou）
        
        liucheng：
        1. jisuanriqifanwei
        2. diaoyongzileihuoquyuanshishuju
        3. biaozhunhualieming
        4. jisuanjishuzhibiao
        
        Args:
            stock_code: gupiaodaima
            start_date: kaishiriqi（kexuan）
            end_date: jieshuriqi（kexuan，morenjintian）
            days: huoqutianshu（dang start_date weizhidingshishiyong）
            
        Returns:
            biaozhunhuade DataFrame，baohanjishuzhibiao
        """
        # jisuanriqifanwei
        if end_date is None:
    ...
    def _clean_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        chuli：
        1. quebaoriqiliegeshizhengque
        2. shuzhileixingzhuanhuan
        3. quchukongzhixing
        4. anriqipaixu
        """
        df = df.copy()
    ...
    def _calculate_indicators(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        jisuanzhibiao：
        - MA5, MA10, MA20: yidongpingjunxian
        - Volume_Ratio: liangbi（jinrichengjiaoliang / 5ripingjunchengjiaoliang）
        """
        df = df.copy()
    ...
    def random_sleep(min_seconds: float = 1.0, max_seconds: float = 3.0) -> None:
        """
        zhinengsuijixiumian（Jitter）
        
        fangfengjincelve：monirenleixingweidesuijiyanchi
        zaiqingqiuzhijianjiarubuguizededengdaishijian
        """
...
class DataFetcherManager:
    """
    shujuyuancelveguanliqi
    
    zhize：
    1. guanliduogeshujuyuan（anyouxianjipaixu）
    2. zidongguzhangqiehuan（Failover）
    3. tigongtongyideshujuhuoqujiekou
    
    qiehuancelve：
    - youxianshiyonggaoyouxianjishujuyuan
    - shibaihouzidongqiehuandaoxiayige
    - suoyoushujuyuandoushibaishipaochuyichang
    """
    ...
    def __init__(self, fetchers: Optional[List[BaseFetcher]] = None):
        ...
        Args:
            fetchers: shujuyuanliebiao（kexuan，morenanyouxianjizidongchuangjian）
        """
    ...
    def _get_fundamental_cache_key(self, stock_code: str, budget_seconds: Optional[float] = None) -> str:
        """shengchengjibenmianhuancun key（baohanyusuanfentongyibimiandiyusuanjieguowurangaoyusuanqingqiu）。"""
    ...
    def _init_default_fetchers(self) -> None:
        """
        chushihuamorenshujuyuanliebiao
    ...
    def add_fetcher(self, fetcher: BaseFetcher) -> None:
        """tianjiashujuyuanbingzhongxinpaixu"""
        self._ensure_concurrency_guards()
        with self._fetchers_lock:
    ...
    def get_daily_data(
        ...
        Returns:
            Tuple[DataFrame, str]: (shuju, chenggongdeshujuyuanmingcheng)
    ...
    def available_fetchers(self) -> List[str]:
        """fanhuikeyongshujuyuanmingchengliebiao"""
    ...
    def prefetch_realtime_quotes(self, stock_codes: List[str]) -> int:
        ...
        2. ruguobubaohan，tiaoguoyuqu（xinlang/tengxunshidangupiaochaxun，wuxuyuqu）
        3. ruguozixuangushuliang >= 5 qieshiyongquanliangshujuyuan，zeyuqutianchonghuancun
        
        zheyangzuodehaochu：
        - shiyongxinlang/tengxunshi：meizhigupiaodulichaxun，wuquanlianglaquwenti
        - shiyong efinance/dongcaishi：yuquyici，houxuhuancunmingzhong
        
        Args:
            stock_codes: daifenxidegupiaodaimaliebiao
    ...
    def get_realtime_quote(self, stock_code: str, *, log_final_failure: bool = True):
        """
        huoqushishixingqingshuju（zidongguzhangqiehuan）
        
        guzhangqiehuancelve（anpeizhideyouxianji）：
        1. meigu：shiyong YfinanceFetcher.get_realtime_quote()
    ...
    def get_chip_distribution(self, stock_code: str):
        ...
        3. yicichangshiduogeshujuyuan：shujuyuanyouxianjiyuhuoqudailydeshujuyouxianjiyizhi
    ...
    def get_stock_name(self, stock_code: str, allow_realtime: bool = True) -> Optional[str]:
        """
        huoqugupiaozhongwenmingcheng（zidongqiehuanshujuyuan）
        ...
        4. yicichangshigegeshujuyuande get_stock_name fangfa
    ...
    def batch_get_stock_names(self, stock_codes: List[str]) -> Dict[str, str]:
        ...
        xianchangshicongzhichipiliangchaxundeshujuyuanhuoqugupiaoliebiao，
        ranhouzaizhugechaxunqueshidegupiaomingcheng。
        
        Args:
            stock_codes: gupiaodaimaliebiao
            
        Returns:
            {gupiaodaima: gupiaomingcheng} zidian
        """
        result = {}
    ...
    def get_main_indices(self, region: str = "cn") -> List[Dict[str, Any]]:
        """huoquzhuyaozhishushishixingqing（zidongqiehuanshujuyuan）"""
        if region == "cn":
    ...
    def get_market_stats(self) -> Dict[str, Any]:
        """huoqushichangzhangdietongji（zidongqiehuanshujuyuan）"""
        tickflow_fetcher = self._get_tickflow_fetcher()
        if tickflow_fetcher is not None:
            try:
    ...
    def get_sector_rankings(self, n: int = 5) -> Tuple[List[Dict], List[Dict]]:
        """huoqubankuaizhangdiebang（zidongqiehuanshujuyuan）"""
    ...
    def get_concept_rankings(self, n: int = 5) -> Tuple[List[Dict], List[Dict]]:
        """huoqugainian/ticaizhangdiebang（zidongqiehuanshujuyuan）。"""
        last_error = ""
        for fetcher in self._fetchers:
            try:
    ...
    def get_hot_stocks(self, n: int = 10) -> List[Dict[str, Any]]:
        """huoqushichangrenqigubang（zidongqiehuanshujuyuan）。"""
        last_error = ""
        for fetcher in self._fetchers:
            try:
    ...
    def get_limit_up_pool(
        ...
        """huoquzhangtingchiyulianbantidui（zidongqiehuanshujuyuan）。"""
        last_error = ""
        for fetcher in self._fetchers:
            try:
