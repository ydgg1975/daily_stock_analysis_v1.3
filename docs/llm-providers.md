...
| MiniMax | `minimax` | `openai` | `https://api.minimaxi.com/v1` | `MiniMax-M3,MiniMax-M2.7,MiniMax-M2.7-highspeed` |
...
| MiniMax | [OpenAI API 兼容](https://platform.minimax.io/docs/api-reference/text-chat)、[获取模型列表](https://platform.minimax.io/docs/api-reference/models/openai/list-models) | 官方 OpenAI-compatible Base URL 为 `https://api.minimaxi.com/v1`（注意域名是 minimax**i**.com），旗舰模型 `MiniMax-M3`，另有 `MiniMax-M2.7`、`MiniMax-M2.7-highspeed`。 |
