...
| [Analysis Context Pack P0 Inventory](analysis-context-pack.md) <sub><sub>![P0 Badge](https://img.shields.io/badge/P0-red?style=flat)</sub></sub> (Chinese-only) | AnalysisContextPack first-scope boundaries, field quality states, and source anchors |
| [Extension Runtime Contract](extensions.md) <sub><sub>![P1 Badge](https://img.shields.io/badge/P1-orange?style=flat)</sub></sub> (Chinese-only) | P0/P1 plugin contract, Action Runtime, permission guards, task metadata, and AlphaSift follow-up boundaries |
