...
- 🎨 **Web UI design system foundation** — `apps/dsa-web` 新增语义化 design tokens、升级 `components/common` 原子组件库，并补齐 `Input`、`EmptyState`、`PageHeader`、`StatCard`、`Toolbar` 等公共组件，为后续 Shell 和页面级重构提供统一 UI 底座
### Fixed
