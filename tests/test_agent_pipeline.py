...
class TestAgentFactorySkillBaseline(unittest.TestCase):
    ...
    def test_implicit_default_run_keeps_default_skill_policy(self):
        ...
        self.assertIn("yanjincelve", kwargs["default_skill_policy"])
...
class TestAgentResultConversion(unittest.TestCase):
    ...
    def test_convert_success_dashboard(self):
        ...
        dashboard = {
            ...
            "dashboard": {"core_conclusion": {"one_sentence": "kanhao"}},
        ...
        result = pipeline._agent_result_to_analysis_result(
            ...
            agent_result, "600519", "guizhoumaotai", ReportType.SIMPLE, "q123"
        ...
        self.assertEqual(result.trend_prediction, "kanduo")
    ...
    def test_convert_failed_dashboard(self):
        ...
        self.assertEqual(result.operation_advice, "guanwang")
    ...
    def test_convert_invalid_dashboard_preserves_local_trend_result(self):
        ...
        self.assertEqual(result.trend_prediction, "duotoupailie")
    ...
    def test_convert_empty_dashboard_backfills_local_trend_dashboard(self):
        ...
        trend_result = TrendAnalysisResult(
            ...
            risk_factors=["diepo MA20 xuzhisun"],
        ...
        self.assertEqual(result.dashboard["intelligence"]["risk_alerts"], ["diepo MA20 xuzhisun"])
    ...
    def test_convert_missing_decision_type_preserves_conditional_hold_advice(self):
        ...
        agent_result = AgentResult(
            ...
            dashboard={
                ...
                "operation_advice": "budiepozhichengweijixuchiyou",
        ...
        self.assertEqual(result.operation_advice, "budiepozhichengweijixuchiyou")
    ...
    def test_convert_empty_top_level_advice_uses_nested_dashboard_advice(self):
        ...
        self.assertEqual(result.operation_advice, "jiancang")

        self.assertEqual(result.decision_type, "sell")

        self.assertEqual(result.dashboard["operation_advice"], "jiancang")
    ...
    def test_convert_malformed_top_level_summary_uses_nested_dashboard_summary(self):
        ...
        agent_result = AgentResult(
            ...
            dashboard={
                ...
                "dashboard": {
                    ...
                    "analysis_summary": "AI yigeichudezhaiyao",
        ...
        self.assertEqual(result.analysis_summary, "AI yigeichudezhaiyao")

        self.assertEqual(result.dashboard["analysis_summary"], "AI yigeichudezhaiyao")
    ...
    def test_convert_malformed_scalar_fields_fallback_to_trend_result(self):
        ...
        self.assertEqual(result.dashboard["trend_prediction"], "duotoupailie")
    ...
    def test_convert_partial_dashboard_uses_trend_fallback_for_missing_scalars(self):
        ...
        agent_result = AgentResult(
            ...
            dashboard={
                ...
                "dashboard": {
                    ...
                    "core_conclusion": {"one_sentence": "AI yigeichudehexinjielun"},

                    "intelligence": {"risk_alerts": ["AI fengxian"]},

                    "battle_plan": {"sniper_points": {"take_profit": "120yuan"}},
        ...
        self.assertEqual(result.dashboard["core_conclusion"]["one_sentence"], "AI yigeichudehexinjielun")

        self.assertEqual(result.dashboard["intelligence"]["risk_alerts"], ["AI fengxian"])
    ...
    def test_convert_risk_alerts_string_placeholder_uses_local_risk_factors(self):
        ...
        agent_result = AgentResult(
            ...
            dashboard={
                ...
                "dashboard": {
                    ...
                    "intelligence": {"risk_alerts": "daibuchong"},
        ...
        trend_result = TrendAnalysisResult(
            ...
            risk_factors=["zhangfuguokuai", "huichefangda"],
        ...
        self.assertEqual(result.dashboard["intelligence"]["risk_alerts"], ["zhangfuguokuai", "huichefangda"])
    ...
    def test_convert_placeholder_dashboard_is_completed_from_local_context(self):
        ...
        agent_result = AgentResult(
            ...
            dashboard={
                ...
                "dashboard": {
                    ...
                    "core_conclusion": {"one_sentence": "daibuchong"},
        ...
        trend_result = TrendAnalysisResult(
            ...
            risk_factors=["qushidiepozhichengxujiancang"],
        ...
        self.assertEqual(result.dashboard["intelligence"]["risk_alerts"], ["qushidiepozhichengxujiancang"])
    ...
    def test_convert_invalid_dashboard_normalizes_strong_trend_decision_type(self):
        ...
        cases = [
            ...
            (BuySignal.STRONG_BUY, "buy", "qiangliemairu"),

            (BuySignal.STRONG_SELL, "sell", "qiangliemaichu"),
    ...
    def test_convert_uses_dashboard_stock_name_when_input_is_placeholder(self):
        ...
        agent_result = AgentResult(
            ...
            dashboard={
                ...
                "stock_name": "kechuangxinpianETF",

                "sentiment_score": 75,

                "trend_prediction": "zhendangpianduo",
        ...
        result = pipeline._agent_result_to_analysis_result(
            ...
            agent_result, "588200", "gupiao588200", ReportType.SIMPLE, "q-placeholder"

        )

        self.assertEqual(result.name, "kechuangxinpianETF")
    ...
    def test_convert_keeps_input_stock_name_when_valid(self):
        ...
        result = pipeline._agent_result_to_analysis_result(
            ...
            agent_result, "600519", "guizhoumaotai", ReportType.SIMPLE, "q-valid"
...
class TestAnalyzeWithAgentStockName(unittest.TestCase):
    ...
    def test_analyze_with_agent_uses_resolved_name_for_news_persistence(self):
        ...
        with patch('src.core.pipeline.get_config') as mock_config, \
            ...
            self.assertEqual(saved_kwargs["name"], "kechuangxinpianETF")
        ...
        with patch('src.core.pipeline.get_config') as mock_config, \
            ...
            agent_result = AgentResult(
                ...
                dashboard={
                    ...
                    "analysis_summary": "yuanshijianyi",

                    "dashboard": {

                        "core_conclusion": {"one_sentence": "chushijielun"},
            ...
            self.assertEqual(result.operation_advice, "xipanguancha")

            self.assertEqual(result.dashboard.get("decision_type"), "hold")

            self.assertEqual(result.dashboard.get("operation_advice"), "xipanguancha")
...
class TestAgentConstructionChain(unittest.TestCase):
    ...
    def test_full_construction_chain(self):
        ...
        self.assertIn("ceshicelve", instructions)
...
class TestSafeInt(unittest.TestCase):
    ...
    def test_string_with_unit(self):
        ...
        """LLM may return '80fen' instead of 80."""

        safe_int = self._get_safe_int()

        self.assertEqual(safe_int("80fen"), 80)
...
class TestSkillActivation(unittest.TestCase):
    ...
    def test_activate_all(self):
        ...
        skill1 = Skill(name="dragon_head", display_name="longtoucelve",

                       description="test", instructions="test")

        skill2 = Skill(name="shrink_pullback", display_name="suolianghuicai",
    ...
    def test_activate_specific(self):
        ...
        skill3 = Skill(name="volume_breakout", display_name="fangliangtupo",
    ...
    def test_sentiment_score_parsed_from_dashboard(self):
        ...
        with patch('src.core.pipeline.get_config') as mock_config, \
            ...
            # Dashboard with "80fen" instead of 80
