...
class TestTickFlowFetcher(unittest.TestCase):
    ...
    def test_get_market_stats_calculates_a_share_rules(self):
        ...
        fetcher._client = _FakeClient(
            universe_data=[
                _quote("600000.SH", last_price=11.0, prev_close=10.0, amount=1e8, name="pufayinhang"),
                _quote("300750.SZ", last_price=12.0, prev_close=10.0, amount=1e8, name="ningdeshidai"),
                _quote("688001.SH", last_price=8.0, prev_close=10.0, amount=1e8, name="kechuangceshi"),
                _quote("920001.BJ", last_price=13.0, prev_close=10.0, amount=1e8, name="beijiaoceshi"),
                _quote("600001.SH", last_price=10.5, prev_close=10.0, amount=1e8, name="*STshili"),
                _quote("600002.SH", last_price=10.0, prev_close=10.0, amount=1e8, name="pingpanshili"),
                _quote("600003.SH", last_price=11.0, prev_close=10.0, amount=0.0, name="lingchengjiaoe"),
                _quote("600004.SH", last_price=11.0, prev_close=None, amount=1e8, name="quezuoshou"),
            ]
        )
