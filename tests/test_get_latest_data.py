...
"""
===================================
get_latest_data ceshi
===================================

zhize：
1. yanzheng get_latest_data fangfa
2. ceshifanhuishujuanriqijiangxupailie
3. ceshi days canshuxianzhi
"""
...
class GetLatestDataTestCase(unittest.TestCase):
    ...
    def test_get_latest_data_ordered_by_date_desc(self) -> None:
        """yanzhengshujuanriqijiangxupailie"""
        # charu3tianshuju
        for i in range(3):
            self._insert_stock_data("600519", days_ago=i, close=100.0 + i)
        ...
        # yanzhengriqijiangxu（zuixinriqizaiqian）
    ...
    def test_get_latest_data_filters_by_code(self) -> None:
        """yanzhengangupiaodaimaguolv"""
        # charubutonggupiaodeshuju
