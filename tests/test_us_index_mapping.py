# -*- coding: utf-8 -*-
"""
data_provider/us_index_mapping.py dedanyuanceshi
"""
import unittest
import sys
import os

# quebaonengdaoru data_provider mokuai（zhijiedaorubimianjiazaizhongliangjiyilai）
