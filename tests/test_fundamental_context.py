...
class TestFundamentalContext(unittest.TestCase):
    ...
    def test_sector_rankings_use_ordered_fallback(self) -> None:
        ...
        tushare = _DummyFetcher(
            ...
            rankings=([{"name": "bandaoti", "change_pct": 1.0}], [{"name": "xiaofei", "change_pct": -1.0}]),
        ...
        efinance = _DummyFetcher(
            ...
            rankings=([{"name": "dichan", "change_pct": 2.0}], [{"name": "meitan", "change_pct": -2.0}]),
        ...
        self.assertEqual(top[0]["name"], "dichan")

        self.assertEqual(bottom[0]["name"], "meitan")
    ...
    def test_fundamental_context_aggregates_blocks(self) -> None:
        ...
        with patch("src.config.get_config", return_value=cfg), \
                ...
                patch("data_provider.fundamental_adapter.AkshareFundamentalAdapter.get_fundamental_bundle", return_value={
                    ...
                    "earnings": {"forecast_summary": "yuzeng"},
    ...
    def test_get_belong_boards_from_capability_probe(self) -> None:
        ...
        fetcher = _DummyBoardFetcher(
            ...
            boards=[{"name": "baijiu"}, {"board_name": "xiaofei"}],
        ...
        self.assertEqual(boards[0]["name"], "baijiu")

        self.assertEqual(boards[1]["name"], "xiaofei")
    ...
    def test_get_belong_boards_preserves_cn_code_and_type_fields(self) -> None:
        ...
        fetcher = _DummyBoardFetcher(
            ...
            boards=[
                ...
                {"bankuaimingcheng": "baijiu", "bankuaidaima": "BK0815", "bankuaileixing": "hangye"},

                {"bankuai": "xiaofei", "daima": "BK0475", "leibie": "gainian"},
        ...
        self.assertEqual(
            ...
            {"name": "baijiu", "code": "BK0815", "type": "hangye"},
        ...
        self.assertEqual(
            ...
            {"name": "xiaofei", "code": "BK0475", "type": "gainian"},
    ...
    def test_get_belong_boards_supports_extended_name_aliases_in_dict_payload(self) -> None:
        ...
        fetcher = _DummyBoardFetcher(
            ...
            boards=[
                ...
                {"suoshubankuai": "xinnengyuan"},

                {"bankuaiming": "bandaoti"},
    ...
    def test_missing_value_helpers_keep_common_null_compatibility(self) -> None:
        ...
        self.assertFalse(DataFetcherManager._is_missing_board_value("baijiu"))

        self.assertFalse(DataFetcherManager._has_meaningful_payload(np.array([None, np.nan])))

        self.assertTrue(DataFetcherManager._has_meaningful_payload(np.array([None, "baijiu"])))
