...
class TestExtractStockCode(unittest.TestCase):
    ...
    def test_a_share_chinese_prefix(self):
        ...
        self.assertEqual(_extract_stock_code("fenxi600519"), "600519")



    def test_a_share_chinese_suffix(self):

        self.assertEqual(_extract_stock_code("600519zenmeyang"), "600519")



    def test_a_share_in_sentence(self):

        self.assertEqual(_extract_stock_code("qingbangwokankan600519dezoushi"), "600519")



    def test_a_share_with_prefix_0(self):

        self.assertEqual(_extract_stock_code("fenxi000858"), "000858")



    def test_a_share_with_prefix_3(self):

        self.assertEqual(_extract_stock_code("fenxi300750"), "300750")
    ...
    def test_hk_chinese(self):
        ...
        self.assertEqual(_extract_stock_code("fenxihk00700"), "HK00700")
    ...
    def test_us_ticker_in_chinese(self):
        ...
        self.assertEqual(_extract_stock_code("kankanTSLA"), "TSLA")
    ...
    def test_lowercase_us_ticker_with_analysis_hint(self):
        ...
        self.assertEqual(_extract_stock_code("fenxitsla"), "TSLA")
    ...
    def test_bse_code_with_8_prefix(self):
        ...
        self.assertEqual(_extract_stock_code("fenxi830799"), "830799")



    def test_bse_code_with_92_prefix(self):

        self.assertEqual(_extract_stock_code("kankan920748"), "920748")
...
class TestIntelAgentPostProcess(unittest.TestCase):
    ...
    def test_repairs_json_and_caches_intel_context(self):
...

        {
          ...
          "reasoning": "qingxuzhongxingpianjinshen",

          "risk_alerts": ["gudongjianchi"],

          "positive_catalysts": ["hangyefusu"],
        ...
        self.assertEqual(ctx.get_data("intel_opinion")["positive_catalysts"], ["hangyefusu"])

        self.assertEqual(ctx.risk_flags[0]["description"], "gudongjianchi")
...
class TestOrchestratorModes(unittest.TestCase):
    ...
    def test_build_context_from_dict(self):
        ...
        ctx = orch._build_context(
            ...
            context={"stock_code": "600519", "stock_name": "guizhoumaotai", "skills": ["bull_trend"]},

        )

        self.assertEqual(ctx.stock_code, "600519")

        self.assertEqual(ctx.stock_name, "guizhoumaotai")
    ...
    def test_build_context_extracts_code_from_query(self):
        ...
        ctx = orch._build_context("fenxi600519dezoushi")
    ...
    def test_fallback_summary(self):
        ...
        ctx = AgentContext(query="test", stock_code="600519", stock_name="guizhoumaotai")
...
class TestOrchestratorExecution(unittest.TestCase):
    ...
    def test_execute_pipeline_skips_stage_when_remaining_budget_below_minimum(self):
        ...
        self.assertIn("[jiangjijieguo]", result.dashboard["analysis_summary"])
    ...
    def test_execute_pipeline_timeout_after_decision_preserves_dashboard(self):
        ...
        def _run_decision(run_ctx, progress_callback=None):
            ...
            dashboard = {
                ...
                "operation_advice": {
                    ...
                    "no_position": "fenpibuju",

                    "has_position": "jixuchiyou",
        ...
        self.assertEqual(result.dashboard["operation_advice"], "mairu")
    ...
    def test_execute_pipeline_timeout_after_intel_synthesizes_dashboard(self):
        ...
        ctx = AgentContext(query="test", stock_code="301308", stock_name="jiangbolong")
    ...
    def test_chat_loads_prior_history_into_context(self):
        ...
        history = [
            ...
            {"role": "user", "content": "zhiqiandewenti"},

            {"role": "assistant", "content": "zhiqiandehuida"},
    ...
    def test_chat_persists_failure_message(self):
        ...
        add_message.assert_any_call("session-2", "assistant", "[fenxishibai] boom")
    ...
    def test_execute_pipeline_chat_prefers_free_form_response(self):
        ...
        ctx = AgentContext(query="qingzongjieyixia", stock_code="600519")
        ...
        def fake_run(pipeline_ctx, progress_callback=None):
            ...
            pipeline_ctx.set_data("final_response_text", "zheshiziranyuyanhuifu")

            return self._stage_result("decision", raw_text="zheshiziranyuyanhuifu")
        ...
        self.assertEqual(result.content, "zheshiziranyuyanhuifu")
    ...
    def test_strategy_agents_are_selected_after_technical_stage(self):
        ...
        ctx = AgentContext(query="fenxi600519", stock_code="600519")
...
class TestDecisionAgentChatMode(unittest.TestCase):
    ...
    def test_post_process_stores_free_form_response(self):
        ...
        ctx = AgentContext(query="bangwozongjieyixia", stock_code="600519")

        ctx.meta["response_mode"] = "chat"

        ctx.add_opinion(AgentOpinion(agent_name="technical", signal="buy", confidence=0.8, reasoning="qushipianqiang"))
...
class TestTechnicalAgentSkillPolicy(unittest.TestCase):
    ...
    def test_prompt_omits_legacy_default_policy_when_explicit_skill_selected(self):
        ...
        prompt = agent.system_prompt(AgentContext(query="fenxi 600519", stock_code="600519"))
...
class TestRiskOverride(unittest.TestCase):
    ...
    def _make_dashboard(self):
        ...
        return {
            ...
            "analysis_summary": "yuanshijielun",

            "risk_warning": "yuanfengxiantishi",

            "dashboard": {

                "core_conclusion": {

                    "one_sentence": "keyicanyu",

                    "signal_type": "🟢mairuxinhao",

                    "position_advice": {

                        "no_position": "fenpimairu",
    ...
    def test_risk_override_vetoes_buy_signal(self):
        ...
        ctx.add_opinion(AgentOpinion(agent_name="decision", signal="buy", confidence=0.8, reasoning="yuanshijielun"))
        ...
        ctx.add_opinion(AgentOpinion(
            ...
            reasoning="zhongdafengxian",

            raw_data={"veto_buy": True, "reasoning": "cunzaizhongdajianchifengxian"},

        ))

        ctx.add_risk_flag("insider", "dagudongjianchi", severity="high")
        ...
        self.assertIn("fengkongjieguan", dashboard["risk_warning"])
    ...
    def test_risk_override_normalizes_strong_buy_before_veto(self):
        ...
        ctx.add_opinion(AgentOpinion(agent_name="decision", signal="strong_buy", confidence=0.9, reasoning="yuanshijielun"))
        ...
        ctx.add_opinion(AgentOpinion(
            ...
            raw_data={"veto_buy": True, "reasoning": "cunzaizhongdafengxian"},
...
class TestResearchCommandTimeout(unittest.TestCase):
    ...
    def test_research_timeout_returns_timeout_response(self):
        ...
        self.assertIn("chaoshi", response.text)
    ...
    def test_research_recognizes_five_letter_us_ticker(self):
        ...
        with patch("bot.commands.research.get_config", return_value=config), \
            ...
            response = cmd.execute(msg, ["googl", "fengxian"])
...
class TestResearchAgentFilteredRegistry(unittest.TestCase):
    ...
    def test_decompose_query_uses_shared_adapter(self):
        ...
        result = agent._decompose_query("fenxi 600519", {"stock_code": "600519"})
    ...
    def test_research_marks_synthesis_fallback_as_failure(self):
        ...
        with patch.object(agent, "_decompose_query", return_value={"questions": ["Q1"], "tokens": 3}), \
            ...
            result = agent.research("fenxi 600519")
    ...
    def test_research_returns_timeout_result_when_overall_deadline_is_exceeded(self):
        ...
        with patch.object(agent, "_decompose_query", return_value={"questions": ["Q1"], "tokens": 3}), \
            ...
            result = agent.research("fenxi 600519", timeout_seconds=0.01)
...
class TestAgentResearchEndpoint(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_agent_research_returns_timeout_response(self):
        ...
        with (
            ...
            response = await agent_research(ResearchRequest(question="600519 fengxian"))
