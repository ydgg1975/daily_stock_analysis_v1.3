...
class TestFetcherLogging(unittest.TestCase):
    def test_base_fetcher_logs_start_and_success(self):
        ...
        self.assertIn("[SuccessFetcher] kaishihuoqu 600519 rixianshuju", log_text)
        self.assertIn("[SuccessFetcher] 600519 huoquchenggong:", log_text)
    ...
    def test_manager_logs_fallback_and_final_success(self):
        ...
        self.assertIn("[shujuyuanchangshi 1/2] [FailureFetcher] huoqu 601006...", log_text)
        self.assertIn("[shujuyuanshibai 1/2] [FailureFetcher] 601006:", log_text)
        self.assertIn("[shujuyuanqiehuan] 601006: [FailureFetcher] -> [SuccessFetcher]", log_text)
        self.assertIn("[shujuyuanwancheng] 601006 shiyong [SuccessFetcher] huoquchenggong:", log_text)
    ...
    def test_efinance_rejects_hk_daily_without_calling_eastmoney(self, mock_get_config):
        ...
        self.assertIn("buzhichiganggurixian", str(captured.exception))
    ...
    def test_efinance_logs_eastmoney_endpoint_on_remote_disconnect(self):
        ...
        log_text = "\n".join(captured.output)
        self.assertIn("Eastmoney lishiKxianjiekoushibai:", log_text)
