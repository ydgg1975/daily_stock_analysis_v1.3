...
def _build_config(**overrides):
    config = Config(
        ...
        litellm_fallback_models=["openai/gpt-5.2"],
        llm_model_list=[],
        llm_channels=[],
...
class AgentModelsApiTestCase(unittest.TestCase):
        ...
        config = _build_config(
            ...
            llm_model_list=[
                ...
                },
                {
                    ...
                    "litellm_params": {"model": "openai/gpt-5.2", "api_key": "secret-2"},
                },
            ],
        )
    ...
    def test_models_endpoint_resolves_legacy_placeholders_to_real_models(self) -> None:
        ...
        self.assertEqual(deployments[2]["model"], "openai/gpt-5.2")
    ...
    def test_models_endpoint_resolves_unprefixed_legacy_openai_model_names(self) -> None:
        ...
        self.assertEqual(deployments[0]["model"], "gpt-5.2")
    ...
    def test_models_endpoint_collapses_legacy_fallbacks_to_single_runtime_deployment(self) -> None:
        ...
        self.assertEqual(fallback[0]["model"], "openai/gpt-5.2")
        self.assertEqual(fallback[0]["deployment_id"], "legacy:openai:0:openai/gpt-5.2")
...
class AgentModelsEndpointTestCase(unittest.TestCase):
    def test_endpoint_returns_sorted_models_without_secrets(self) -> None:
        ...
        self.assertEqual(payload["models"][1]["model"], "openai/gpt-5.2")
...
class AgentModelsSourceDetectionTestCase(unittest.TestCase):
    ...
    def test_load_from_env_marks_channels_as_actual_source_after_yaml_fallback(
        ...
        env = {
            ...
            "LLM_PRIMARY_MODELS": "openai/gpt-5.2",
            "OPENAI_API_KEY": "",
            "AIHUBMIX_KEY": "",
            "GEMINI_API_KEY": "",
            "ANTHROPIC_API_KEY": "",
        ...
        self.assertEqual(config.llm_model_list[0]["litellm_params"]["model"], "openai/gpt-5.2")
