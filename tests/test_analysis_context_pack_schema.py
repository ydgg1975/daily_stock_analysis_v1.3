...
@pytest.mark.parametrize(
    "timestamp",
    ("2026-05-24T09:30:00+08:00", "2026-05-24T01:30:00Z"),
)
def test_item_and_block_timestamp_use_iso_strings(timestamp: str) -> None:
    ...
    assert dumped["items"]["price"]["timestamp"] == timestamp
