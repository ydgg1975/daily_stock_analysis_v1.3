...
def _ensure_report_action_fields(report_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    action_fields = build_action_fields(
        ...
        explicit_action=summary.get("action") or raw_result.get("action"),
...
def _build_analysis_report(
    ...
    action_fields = build_action_fields(
        ...
        explicit_action=summary_data.get("action") or details_data.get("action") or raw_result_data.get("action"),
