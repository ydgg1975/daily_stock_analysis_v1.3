...
class TestNotificationChannelRequest(BaseModel):
    ...
    title: str = Field(default="DSA notificationtest", min_length=1, max_length=80)

    content: str = Field(default="zheshiyitiaolaizi DSA Web shezhiyedenotificationtestxiaoxi??, min_length=1, max_length=1000")
